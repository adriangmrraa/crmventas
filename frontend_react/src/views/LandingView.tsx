...
export default function LandingView() {
  return (
    <div className="landing-root min-h-screen min-h-[100dvh] flex flex-col bg-gradient-to-b from-[#06060e] via-transparent to-transparent">
      ...
      <main className="flex-1 flex flex-col items-center justify-center w-full px-4 py-8 sm:p-6 md:p-8 pb-12 sm:pb-16">
        <div className="w-full max-w-md sm:max-w-lg mx-auto space-y-6 sm:space-y-8">
          ...
          <header className="text-center pt-2 sm:pt-0">
            ...
            <p className="mt-3 sm:mt-4 text-sm sm:text-base text-white/50 max-w-sm mx-auto leading-relaxed">
            ...
            <div className="p-4 sm:p-6 space-y-4 sm:space-y-5">
              ...
              <details className="group">
                ...
                <div className="mt-2 pt-3 border-t border-white/[0.04] rounded-xl bg-white/[0.02]/80 px-4 py-3 text-sm text-white/70 font-mono">
                  ...
                  <p className="mt-1"><span className="text-white/40">Contraseña:</span> [REDACTED]</p>
                </div>
              </details>
            </div>
          </section>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="pt-2">
              <Link
                to="/login"
                className="flex items-center justify-center gap-2 w-full rounded-xl py-3 text-sm font-medium text-white/50 hover:text-white hover:bg-white/[0.04] transition-colors min-h-[44px] touch-manipulation"
              >
                <LogIn size={18} />
