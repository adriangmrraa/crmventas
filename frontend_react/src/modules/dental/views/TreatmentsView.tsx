      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-4 lg:p-6 custom-scrollbar">
        ...
        <div className="mb-10 p-6 bg-white/[0.03] backdrop-blur-xl border border-white/[0.06]/[0.06] rounded-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
            ...
            <div className="flex items-center gap-4 p-4 bg-white/[0.03] rounded-2xl border border-white/[0.06]/[0.06] hover:border-green-500/20 transition-colors">
              <div className="p-3 bg-green-500/100/10 text-green-400 rounded-xl">
                <Clock size={20} />
              </div>
              <div className="flex flex-col">
                <span className="text-white/40 font-medium uppercase text-[10px] tracking-wider">{t('treatments.deep_cleaning')}</span>
                <span className="text-white font-bold text-lg">30 min</span>
              </div>
            </div>
            <div className="flex items-center gap-4 p-4 bg-white/[0.03] rounded-2xl border border-white/[0.06]/[0.06] hover:border-red-500/20 transition-colors">
              <div className="p-3 bg-red-500/100/10 text-red-400 rounded-xl">
                <Clock size={20} />
              </div>
              <div className="flex flex-col">
                <span className="text-white/40 font-medium uppercase text-[10px] tracking-wider">{t('treatments.complex_treatment')}</span>
                <span className="text-white font-bold text-lg">60 min</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="bg-[#0d1117] rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
              <div className="flex justify-between items-center gap-3 p-4 sm:p-6 border-b border-white/[0.04] shrink-0">
                ...
                <button
                  ...
                  className="p-2 rounded-xl text-white/30 hover:text-white/50 hover:bg-white/[0.06] transition-all shrink-0"
              ...
              <div className="flex-1 min-h-0 overflow-y-auto p-4 sm:p-6">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                  <div className="space-y-2">
                    <label className="block text-sm font-semibold text-white/70">{t('treatments.name')}</label>
                    <input
                      type="text"
                      value={newForm.name || ''}
                      onChange={(e) => setNewForm({ ...newForm, name: e.target.value })}
                      placeholder={t('treatments.placeholder_name')}
                      className="w-full px-4 py-3 border border-white/[0.06]/[0.06] rounded-xl focus:ring-2 focus:ring-medical-500/20 focus:border-medical-500 outline-none font-medium"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="block text-sm font-semibold text-white/70">{t('treatments.code_unique')}</label>
                    <input
                      type="text"
                      value={newForm.code || ''}
                      onChange={(e) => setNewForm({ ...newForm, code: e.target.value.toLowerCase().replace(/\s+/g, '_') })}
                      placeholder={t('treatments.placeholder_code')}
                      className="w-full px-4 py-3 border border-white/[0.06]/[0.06] rounded-xl focus:ring-2 focus:ring-medical-500/20 focus:border-medical-500 outline-none font-mono text-sm"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="block text-sm font-semibold text-white/70">{t('treatments.category')}</label>
                    <div className="relative">
                      <select
                        value={newForm.category || 'restorative'}
                        onChange={(e) => setNewForm({ ...newForm, category: e.target.value })}
                        className="w-full px-4 py-3 border border-white/[0.06]/[0.06] rounded-xl focus:ring-2 focus:ring-medical-500/20 focus:border-medical-500 outline-none appearance-none cursor-pointer font-medium text-white/70"
                      >
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-2 sm:col-span-2">
                    <label className="block text-sm font-semibold text-white/70">{t('treatments.description')}</label>
                    <textarea
                      value={newForm.description || ''}
                      onChange={(e) => setNewForm({ ...newForm, description: e.target.value })}
                      placeholder={t('treatments.placeholder_description')}
                      className="w-full px-4 py-3 border border-white/[0.06]/[0.06] rounded-xl focus:ring-2 focus:ring-medical-500/20 focus:border-medical-500 outline-none resize-none font-medium h-[100px]"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 border border-white/[0.06]/[0.06] rounded-xl focus:ring-2 focus:ring-medical-500/20 focus:border-medical-500 outline-none font-bold text-white/70"
                      />
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 border border-white/[0.06]/[0.06] rounded-xl focus:ring-2 focus:ring-medical-500/20 focus:border-medical-500 outline-none appearance-none cursor-pointer font-bold text-white/70"
                    >
              ...
              <div className="flex justify-end gap-3 p-4 sm:p-6 border-t border-white/[0.04] shrink-0 bg-white/[0.02]">
                <button
                  type="button"
                  onClick={() => setIsCreating(false)}
                  className="px-5 py-2.5 text-white/50 font-semibold hover:bg-white/[0.08] rounded-xl transition-all"
                >
                  {t('common.cancel')}
                </button>
                <button
        ...
        {loading ? (
          <div className="p-20 text-center flex flex-col items-center">
            <div className="w-16 h-16 border-4 border-white/[0.06] border-t-medical-600 rounded-full animate-spin mb-6"></div>
            <p className="font-bold text-white/30 text-lg">{t('treatments.syncing_services')}</p>
          </div>
        ) : (
          <div className="space-y-12 pb-20">
            {Object.entries(groupedTreatments).map(([category, categoryTreatments]) => (
              <div key={category} className="bg-white/[0.03] backdrop-blur-xl rounded-[2.5rem] border border-white/[0.06]/[0.06] overflow-hidden group">
                <div className="p-6 border-b border-white/[0.06] bg-white/[0.03] flex justify-between items-center sticky top-0 z-10 backdrop-blur-md transition-colors group-hover:bg-white/[0.04]">
                  <div className="flex items-center gap-4">
                    <div className="p-3 bg-white/[0.03] rounded-2xl  border border-white/[0.06]/[0.06]">
                      {categoryIcons[category] || <Stethoscope size={24} className="text-white/50" />}
                    </div>
                    <div>
                  ...
                  {categoryTreatments.map((treatment) => (
                    <div key={treatment.id} className="p-6 hover:bg-white/[0.04] transition-all">
                      {editingId === treatment.id ? (
                        // Edit Mode
                        <div className="space-y-6 bg-white/[0.03] p-6 rounded-3xl border border-white/[0.06]/[0.06]  animate-in fade-in zoom-in-95 duration-300">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06]/[0.06] rounded-xl focus:ring-4 focus:ring-medical-500/10 focus:border-medical-500 outline-none transition-all font-semibold"
                              />
                            </div>
                            <div className="space-y-2">
                              ...
                              <input
                                ...
                                value={editForm.code || ''}
                                disabled
                                className="w-full px-4 py-3 bg-white/[0.02] border border-white/[0.06]/[0.04] rounded-xl text-white/30 font-mono text-sm cursor-not-allowed"
                              />
                            </div>
                          </div>
                          ...
                          <div className="space-y-2">
                            ...
                            <textarea
                              ...
                              rows={2}
                              className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06]/[0.06] rounded-xl focus:ring-4 focus:ring-medical-500/10 focus:border-medical-500 outline-none transition-all resize-none font-medium text-white/50"
                            />
                          </div>
                            ...
                            <div className="grid grid-cols-3 gap-6">
                              <div className="space-y-1">
                                ...
                                <input
                                  ...
                                  className="w-full px-3 py-2 bg-white/[0.04] border border-white/[0.06]/[0.06] rounded-lg focus:ring-2 focus:ring-medical-400 outline-none font-bold text-white text-center"
                                />
                              </div>
                              <div className="space-y-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-2">
                              ...
                              <select
                                ...
                                className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.06]/[0.06] rounded-xl focus:ring-4 focus:ring-medical-500/10 focus:border-medical-500 outline-none appearance-none font-bold text-white/70"
                              >
                                <option value="low">{t('treatments.low')}</option>
                                <option value="medium">{t('treatments.medium')}</option>
                                <option value="high">{t('treatments.high')}</option>
                              ...
                              <label className="flex items-center gap-3 cursor-pointer group">
                                <div className="relative flex items-center">
                                  <input
                                    ...
                                    className="peer h-6 w-6 cursor-pointer appearance-none rounded-lg border border-white/[0.06]/[0.06] bg-white/[0.03] transition-all checked:bg-purple-600 checked:border-purple-600 "
                                  />
                                  <CheckCircle className="absolute hidden h-4 w-4 text-white peer-checked:block left-1" />
                                </div>
                                <span className="text-sm font-bold text-white/40 group-hover:text-purple-400 transition-colors">{t('treatments.multiple_sessions')}</span>
                              </label>
                              ...
                              <label className="flex items-center gap-3 cursor-pointer group">
                                <div className="relative flex items-center">
                                  <input
                                    ...
                                    className="peer h-6 w-6 cursor-pointer appearance-none rounded-lg border border-white/[0.06]/[0.06] bg-white/[0.03] transition-all checked:bg-green-600 checked:border-green-600 "
                                  />
                                  <CheckCircle className="absolute hidden h-4 w-4 text-white peer-checked:block left-1" />
                                </div>
                                <span className="text-sm font-bold text-white/40 group-hover:text-green-400 transition-colors">{t('treatments.active')}</span>
                              </label>
                          ...
                          <div className="flex justify-end gap-3 pt-4 border-t border-white/[0.04]">
                            <button
                              ...
                              className="px-6 py-2.5 text-white/40 font-bold hover:bg-white/[0.06] rounded-xl transition-all"
                            >
                              {t('common.cancel')}
                            </button>
                            <button
                        ...
                        <div className="flex items-start justify-between group/item">
                          <div className="flex-1">
                            <div className="flex items-center flex-wrap gap-3 mb-3">
                              ...
                              <span className={`inline-flex items-center px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border ${treatment.complexity_level === 'high' ? 'bg-red-500/10 text-red-400 border-red-500/20' :
                                treatment.complexity_level === 'medium' ? 'bg-yellow-500/10 text-amber-600 border-yellow-500/20' :
                              ...
                              {!treatment.is_active && (
                                <span className="inline-flex items-center px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest bg-white/[0.04] text-white/30 border border-white/[0.06]/[0.06]">
                            ...
                            <div className="flex flex-wrap items-center gap-y-2 gap-x-8">
                              <div className="flex items-center gap-2.5">
                                ...
                                <span className="text-white/50 text-sm font-semibold">
                                  <strong className="text-white text-base">{treatment.default_duration_minutes}</strong> min <span className="text-white/30 font-medium">{t('treatments.min_standard')}</span>
                                </span>
                              </div>
                              ...
                              <div className="flex items-center gap-4 text-xs font-bold text-white/30 uppercase tracking-tight">
                                <span>{t('treatments.min_short')}: <span className="text-white/70">{treatment.min_duration_minutes}m</span></span>
                                <span>{t('treatments.max_short')}: <span className="text-white/70">{treatment.max_duration_minutes}m</span></span>
                              </div>
                          ...
                          <div className="flex gap-2 opacity-0 group-hover/item:opacity-100 transition-all translate-x-2 group-hover/item:translate-x-0">
                            ...
                            <button
                              ...
                              className="p-3 text-white/30 hover:text-red-400 hover:bg-red-500/100/10 rounded-2xl transition-all  bg-white/[0.03] border border-white/[0.06]"
