      ...
      <PageHeader
        ...
        action={
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 bg-primary hover:bg-violet-700 text-white px-4 py-2.5 rounded-xl transition-colors text-sm font-medium shadow-md active:scale-[0.98]"
          >
            <Plus size={20} />
                    ...
                    <tr key={client.id} className="hover:bg-white/[0.02] transition-colors">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-10 w-10 bg-violet-500/20 rounded-full flex items-center justify-center text-white font-medium">
                ...
                <div key={client.id} className="p-4 bg-white/[0.03] hover:bg-white/[0.02] transition-colors">
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex items-center gap-3">
                      <div className="h-10 w-10 bg-violet-500/20 rounded-full flex items-center justify-center text-white font-medium shrink-0">
                        {(client.first_name || client.phone_number || '?').charAt(0).toUpperCase()}
                      </div>
          ...
          <div className="bg-white/[0.03] rounded-lg w-full max-w-2xl mx-4 my-8">
            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              <div className="flex justify-end gap-3 mt-6">
                ...
                <button type="submit" disabled={saving} className="px-4 py-2 text-white bg-violet-600 rounded-lg hover:bg-violet-700 transition-colors disabled:opacity-50">
