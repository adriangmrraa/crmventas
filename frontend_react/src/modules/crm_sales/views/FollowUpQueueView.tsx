      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
        <div>
          <h1 className="text-xl lg:text-2xl font-bold text-white flex items-center gap-2">
            <Clock className="w-6 h-6 text-medical-400" />
        ...
        <button
          onClick={fetchQueue}
          disabled={loading}
          className="flex items-center gap-2 px-3 py-2 bg-white/[0.03] border border-white/[0.06] rounded-lg text-white/70 hover:text-white hover:border-medical-500/50 transition-all text-sm"
        >
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-white/[0.03] border border-white/[0.06] rounded-lg text-white placeholder-white/30 text-sm focus:outline-none focus:border-medical-500/50"
          />
        </div>
                  ...
                  <div className="px-4 pb-4 border-t border-white/5 pt-3 space-y-3">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-medical-600 hover:bg-medical-700 text-white text-sm font-semibold rounded-lg transition-all"
                      >
          ...
          <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl w-full max-w-lg shadow-2xl">
            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 bg-white/[0.03] border border-white/[0.06] rounded-lg text-white placeholder-white/30 text-sm focus:outline-none focus:border-medical-500/50 resize-none"
                />
              </div>
            ...
            <div className="flex items-center justify-end gap-3 p-5 border-t border-white/5">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-medical-600 hover:bg-medical-700 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-semibold rounded-lg transition-all"
              >
                {submitting ? (
