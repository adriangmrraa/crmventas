                ...
                <div key={option.id} className="space-y-2">
                  ...
                  {option.type === 'checkbox' || option.type === 'multi-select' ? (
                      ...
                      {option.values?.map((value) => (
                        ...
                        >
                          <input
                            ...
                            className="w-4 h-4 rounded border border-white/20 bg-white/5 text-violet-500 transition-all"
                          />
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 rounded border border-white/10 bg-white/5 text-white text-sm focus:outline-none focus:border-violet-500/50 focus:bg-white/10 transition-all"
                    >
